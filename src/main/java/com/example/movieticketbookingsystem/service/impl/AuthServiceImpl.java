...
import com.example.movieticketbookingsystem.config.AppEnv;
...
import com.example.movieticketbookingsystem.mapper.auth.AuthMapper;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse login(LoginRequest loginRequest) {
        ...
        com.example.movieticketbookingsystem.entity.UserDetails userDetails = userRepository.findByEmail(authentication.getName());
